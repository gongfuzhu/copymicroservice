package com.github.microservice.components.data.mongo.timer.config;

import com.github.microservice.components.data.mongo.mongo.domain.SuperEntity;
import com.github.microservice.components.data.mongo.timer.core.SimpleTaskTimerContainer;
import com.github.microservice.components.data.mongo.timer.core.SimpleTaskTimerCore;
import com.github.microservice.components.data.mongo.timer.core.SimpleTaskTimerDao;
...
@EnableScheduling
@ComponentScan({
        "com.github.microservice.components.data.mongo.timer.core",
        "com.github.microservice.components.data.mongo.timer.conf"
})
